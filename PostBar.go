...
type Post struct {
	...
	Follower_num    int    `json:"follower_num"` //跟帖数
...
func (s *PostBar) Init(APIstub shim.ChaincodeStubInterface) sc.Response {
	return shim.Success(nil)
}

func (s *PostBar) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
...
func (s *PostBar) queryPost(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *PostBar) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	posts := []Post{
...
func (s *PostBar) addPost(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *PostBar) updatePost(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *PostBar) richQueryPosts(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *PostBar) getPostNum(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
